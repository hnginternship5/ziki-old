...
<body class="">
    <p class="fof-warning-text">Oops! Loooks like that page doesn't</p> <br> 
    <p class="fof-second-text">exist</p>
    <div class="fof-vector">
        <span class="fof-left-vector"><svg width="70%" height="90%" viewBox="0 0 152 153" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="fof-right-vector">
            <svg width="60%" height="80%" viewBox="0 0 126 132" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="fof-top-vector">
            <svg width="34%" height="8%" viewBox="0 0 59 33" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="fof-top-left-vector">
            <svg width="10%" height="25%" viewBox="0 0 33 58" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="fof-top-middle-vector">
            <svg width="10%" height="25%" viewBox="0 0 39 55" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <span class="fof-return-button">Return to Homepage</span>
